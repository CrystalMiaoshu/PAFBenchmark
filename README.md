...
And we provided a toy dataset to verify our code for encoding. You can download this file, put it in your destination folder, change the path in the code, that the other parameters have been adjusted, and run it the right way.
